...
function do_search()
{
	...
	if(key == "" || key == "Enter%20Search%20Item") {
		url = "http://support.netgear.com/product/RAX40";
...
function goto_wireless()
{
	...
	if(cf.pre_mode.value=="extender")
		parent.loadPage2("ap_settings.html");
	else
		parent.loadPage2("WLG_wireless_dual_band_r10.html");
}
